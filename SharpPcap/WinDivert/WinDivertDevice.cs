...
namespace SharpPcap.WinDivert
{
    public class WinDivertDevice : ICaptureDevice
    {
        ...
        public void Open(DeviceModes mode = DeviceModes.None, int read_timeout = 1000, MonitorMode monitor_mode = MonitorMode.Inactive, uint buffer_size = 0, uint kernel_buffer_size = 0, RemoteAuthentication credentials = null)
        {
            ...
            SetParam(WinDivertParam.QueueSize, buffer_size);
        }
