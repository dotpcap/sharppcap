...
namespace SharpPcap
{
    ...
    public class CaptureDeviceList : ReadOnlyCollection<ICaptureDevice>
    {
        ...
        private NPcap.NPcapDeviceList winPcapDeviceList;
        ...
        public static CaptureDeviceList New()
        {
            ...
            {
                newCaptureDevice.winPcapDeviceList = NPcap.NPcapDeviceList.New();
            }
            else // not windows
            {
            ...
            : base(new List<ICaptureDevice>())
        {
            ...
            if ((Environment.OSVersion.Platform == PlatformID.Win32NT) ||
               (Environment.OSVersion.Platform == PlatformID.Win32Windows))
            {
                winPcapDeviceList = NPcap.NPcapDeviceList.Instance;
            }
            else // not windows
            {
