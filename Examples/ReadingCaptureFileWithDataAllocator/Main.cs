...
namespace ReadingCaptureFileWithDataAllocator
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            // Register a custom packet data allocator
            ((CaptureFileReaderDevice) device).SetDataAllocator(packetSize => ArrayPool<byte>.Shared.Rent((int)packetSize));
        ...
        private static void device_OnPacketArrival(object sender, CaptureEventArgs e)
        {
            ...
            ArrayPool<byte>.Shared.Return(e.Packet.Data);
        }
    }
}
